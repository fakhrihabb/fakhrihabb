          ...
          {projects.map((project) => (
            ...
            >
              ...
              <div className="relative h-64 overflow-hidden">
                ...
                />
                {/* Overlay */}
                <div className="absolute inset-0 bg-gradient-to-t from-bg-primary via-bg-primary/80 to-transparent opacity-60 group-hover:opacity-90 transition-opacity duration-300"></div>

                {/* Category Badge */}
                <div className="absolute top-4 left-4">
                  <span className="px-3 py-1 glass text-xs font-semibold text-brand-primary uppercase tracking-wider">
                    {project.category}
                  </span>
                </div>
              </div>
