...
export const experiences = [
  {
    ...
    description: [
      ...
      "Collaborated with cross-functional teams to implement new features serving 10,000+ users",
  ...
  },
  {
    ...
    duration: "5 months",
    description: [
      "Assisted in managing 3 concurrent software development projects using Agile methodology",
      "Coordinated with stakeholders to gather requirements and define project scope",
      "Created project documentation, timelines, and risk assessment reports",
      "Facilitated daily standups and sprint retrospectives for development teams",
    ],
    technologies: ["Jira", "Confluence", "MS Project", "Miro", "Slack"],
  },
  {
    id: 3,
...
export const projects = [
  {
    ...
    description: "Comprehensive platform for managing campus facilities, bookings, and resource allocation. Features real-time availability tracking, automated scheduling, and analytics dashboard for administrators.",
