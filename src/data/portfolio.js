...
export const wins = [
  {
    id: 1,
    rank: "🥇 1st Place",
    competition: "Hacksphere by Compsphere",
    organizer: "President University x PT Kereta Api Indonesia",
    date: "October 2025",
    description: "Built Quikyu, an AI solution to solve PT KAI's ticketing platform issues, utilizing virtual waiting rooms and AI trust scoring system, winning over 30+ teams with a focus on security, resilience, and UX.",
    image: "/project-images/win-1.jpg",
    categories: ["Hackathon", "AI", "Full-Stack"],
    link: "#",
  },
  {
    id: 2,
    rank: "🥈 2nd Place",
    competition: "NexSolve Paper Competition",
    organizer: "Techtonic 2.0 - IEEE Universitas Indonesia",
    date: "November 2025",
    description: "Written a research paper on AI + IoT solution to revolutionize traditional crowd management on metro train cars, mitigating safety and security risks caused by overcrowding.",
    image: "/project-images/win-2.jpg",
    categories: ["Paper Competition", "Smart City", "AI", "IoT"],
    link: "#",
  },
  {
    id: 3,
    rank: "🥇 1st Place",
    competition: "ASN Digital - AI Hackathon",
    organizer: "Badan Kepegawaian Negara (BKN RI)",
    date: "November 2025",
    description: "Developed Sivana, an AI-powered solution for BKN to enhance the current ASN selection process through SSCASN, reducing operational costs and improving efficiency.",
    image: "/project-images/win-3.jpg",
...
export const projects = [
  ...
  },
  {
    ...
    technologies: ["Python", "Django", "Supabase", "PostgreSQL", "Tailwind CSS"],
  ...
  },
  {
    ...
    technologies: ["Next.js", "Supabase", "Hostinger DNS", "PostgreSQL", "Tailwind CSS"],
    category: "Funded Project for AyoBeraksi",
