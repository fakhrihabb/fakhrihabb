...
export const wins = [
  {
    ...
    categories: ["AI", "Full-Stack", "Cloud Computing"],
    link: "#",
  },
  {
    id: 2,
    rank: "🥈 2nd Place",
    competition: "NexSolve Paper Competition (Techtonic 2.0)",
    organizer: "IEEE Universitas Indonesia",
    date: "November 2025",
  ...
  },
  {
    ...
    date: "October 2025",
    description: "Built Quikyu, an AI solution to solve PT KAI's ticketing platform issues, winning over 30+ teams with a focus on security, resilience, and user experience.",
